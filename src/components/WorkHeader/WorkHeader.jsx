    ...
    <>
      <div className="">
        ...
        <div className="down relative">
          <div className=" hidden lg:flex justify-between z-20">
          ...
          <img className="hidden lg:block absolute -top-10 right-96" src="/img/work-menu/star1.png" alt="" />
          <img className="hidden lg:block absolute top-0 right-72" src="/img/work-menu/star1.png" alt="" />
          <img className="hidden lg:block absolute -top-10 right-52" src="/img/work-menu/star2.png" alt="" />
        </div>
      </div>
    </>
  );
